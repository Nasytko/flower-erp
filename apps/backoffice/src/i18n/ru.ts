...
export const ru = {
  ...
  signIn: 'Войти',
  signingIn: 'Вход…',
  invalidCredentials: 'Неверный логин, пароль или роль',
  roleChallengeField: 'Ваша роль',
  roleChallengeHint: 'Латиницей, как назвал администратор: director, florist или courier',
