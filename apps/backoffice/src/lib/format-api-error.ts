...
const CODE_MESSAGES_RU: Record<string, string> = {
  ...
  BATCH_ALREADY_USED:
    'Нельзя уменьшить количество: часть этой партии уже списана со склада',
  SUPPLY_NOT_CORRECTABLE: 'Эту приёмку уже нельзя править',
  SUPPLY_LINE_NOT_POSTED: 'По позиции нет проведённого оприходования',
